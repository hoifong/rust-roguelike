...
impl Object {
    pub fn new(x: i32, y: i32, char: char, name: &str, color: Color, blocks: bool) -> Self {
        Object {x, y, char, color, name: name.into(), blocks, alive: false}
    }
...
fn player_move_or_attack(dx: i32, dy: i32, game: &Game, objects: &mut Vec<Object>) {
    ...
    match target_id {
        Some(target_id) => {
            println!("The {} laughts at your puny efforts to attack him!", objects[target_id].name);
        }
        None => {
...
fn main() {
    ...
    while !tcod.root.window_closed() {
        ...
        //             str = str + "The " + &object.name + " growls!\n";
        //         }
        //     }
        //     print!("{}", str.to_string());
        // }
